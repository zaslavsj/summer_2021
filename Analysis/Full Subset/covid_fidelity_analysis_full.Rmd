---
title: "COVID-19 Project: RSKC Analysis for Fidelity Scores - Proteases, Receptors, and Integrins Together"
...
ggplot(region.rskc.cluster.matches.ordered, aes(x = Region_1,
                                                y = Region_2,
                                                fill = Matches)) +
  geom_tile() +
...
bubble_clust_path <- file.path(
  here("Plots", paste0("RSKC_bubbleplot_clusters_K=5_full.png"))
  )
...
rskc_dendro2 <- rotate(rskc_dendro, c(4, 5, 3, 2, 1, 17, 18, 14:16, 10:13, 6:9))
...
bubble_region_path <- file.path(
  here("Plots", paste0("RSKC_bubbleplot_regions_K=5_full.png"))
  )
...
viol_plot_path <- file.path(
  here("Plots", paste0("celltype_violin_plot_full.png"))
  )
...
raincloud_plot_path <- file.path(
  here("Plots", paste0("raincloud_plot_full.png"))
  )
