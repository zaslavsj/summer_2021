...
bubble_clust_path <- file.path(
  here("Plots/Proteases-Receptors Subset/RSKC Bubble Plots",
       paste0('RSKC_bubbleplot_clusters_K=6_prorec.png'))
  )
...
bubble_region_path <- file.path(
  here("Plots/Proteases-Receptors Subset/RSKC Bubble Plots",
       paste0('RSKC_bubbleplot_regions_K=6_prorec.png'))
  )
...
viol_plot_path <- file.path(
  here("Plots/Proteases-Receptors Subset/Cluster Violin Plots",
       paste0('celltype_violin_plot_prorec.png'))
  )
...
# cluster.
celltype_raincloud <- ggplot(fidelity_celltype, aes(x = cluster_labels, y = Fidelity, 
                                               fill = cluster_labels)) +
  geom_violinhalf(position = position_nudge(x = 0.15, y = 0)) +
  coord_flip() +
  geom_jitter(aes(colour = cluster_labels), width = 0.1, size = 1, alpha = 0.5) +
...
raincloud_plot_path <- file.path(
  here("Plots/Proteases-Receptors Subset/Cluster Raincloud Plots",
       paste0('raincloud_plot_K=6_prorec.png'))
  )
