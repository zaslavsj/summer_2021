...
## Perform Density-preserving t-SNE
...
# Attempt denSNE on 'weighted_fidelity' data frame.
denSNE_fidelity <- run_densne(weighted_fidelity, no_dims=2, perplexity=5, theta=0.5, randseed=-1,
                              verbose=FALSE, use_pca=FALSE,
                              max_iter=1000, dens_frac=0.3, final_dens=TRUE)
```
