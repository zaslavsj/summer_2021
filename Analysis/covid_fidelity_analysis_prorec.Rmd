...
```{r prepare cluster bubble plot's dataframe}
...
```{r prepare region bubble plot's dataframe}
...
```{r generate violin plot, fig.align = 'center', fig.width = 7, fig.height = 5}
...
viol_plot_path <- file.path(
  here("COVID-19/Figures", paste0('celltype_violin_plot_prorec.png'))
  )
