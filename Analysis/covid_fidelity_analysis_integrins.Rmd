...
region_clust_order <- as.list(labels(rskc_dendro))
...
# according to their cluster labels
cluster_colours <- c("brown2", "brown2", "brown2", "brown2", "darkorange", "darkorange", 
                     "darkorange", "darkorange", "cornflowerblue", "cornflowerblue", 
                     "cornflowerblue", "darkgreen", "darkgreen", "coral1", "coral1", 
