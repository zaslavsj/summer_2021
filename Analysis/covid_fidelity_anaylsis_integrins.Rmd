...
fidelity_clust_bubble_mean <- fidelity_features_clusts %>% 
  ...
  summarize_at(vars(ITGAM_Microglia, ITGB2_Microglia, ITGB1_Oligodendrocyte,
                    ITGAV_Astrocyte, ITGB8_Neuron, ITGAV_Oligodendrocyte,
                    ITGB8_Astrocyte, ITGAL_Microglia), mean) %>%
...
gene_level_order <- c("ITGAM_Microglia", "ITGB2_Microglia", "ITGB1_Oligodendrocyte", 
                      "ITGAV_Astrocyte", "ITGB8_Neuron", "ITGAV_Oligodendrocyte", 
                      "ITGB8_Astrocyte", "ITGAL_Microglia")
...
bubble_clust <- ggplot(fidelity_clust_bubble_mean, aes(x = Gene_Cell, y = cluster_labels)) +
...
region_clust_order <- c("GP", "CLA", "IN", "BF", "LIM", "PCX", "OCX", "CB", "MED",
                        "HIP", "MID", "FCX", "TCX", "STR", "DI", "WM", "AMY", "PON")
